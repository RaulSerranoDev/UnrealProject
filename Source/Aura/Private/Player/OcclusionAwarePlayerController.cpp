...
bool AOcclusionAwarePlayerController::OnHideOccludedActor(const FCameraOccludedActor& OccludedActor) const
{
	...
	OccludedActor.StaticMesh->SetCollisionResponseToChannel(ECC_Visibility, ECollisionResponse::ECR_Ignore);
	OccludedActor.StaticMesh->SetCollisionResponseToChannel(ECC_Selection, ECollisionResponse::ECR_Ignore);
