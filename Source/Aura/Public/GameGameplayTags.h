...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Abilities_Arcane_Charm);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_CombatSocket_Teeth);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_CombatSocket_Head);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Effects_Charm);
